...
function Login() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-tr from-blue-200 via-blue-100 to-blue-50 dark:bg-gradient-to-tr dark:from-gray-900 dark:via-gray-800 dark:to-gray-900">
      ...
      <div className="flex items-center justify-center min-h-screen px-4">
        ...
        >
          ...
          <form onSubmit={handelsubmit}>
            ...
            <button
              className="
              w-full bg-blue-500 text-white p-3 rounded-md
